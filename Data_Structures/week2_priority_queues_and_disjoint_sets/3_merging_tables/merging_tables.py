...
class Database:
    ...
    def merge(self, src, dst):
        ...
        if(self.ranks[dst_parent]>self.ranks[src_parent]):
            ...
            row_count_root = self.row_counts[dst_parent]
            ...
            row_count_root = self.row_counts[src_parent]
            self.row_counts[dst_parent]=0
        if row_count_root > self.max_row_count:
            self.max_row_count = row_count_root
        return True
